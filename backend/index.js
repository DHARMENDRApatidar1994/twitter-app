...
app.use(cors(
  {
    origin: ['https://twitter-app-frontend.vercel.app'],
    method:['GET','POST'],
    credentials: true
  }
));
...
const uri = "mongodb+srv://patidardharmendra1994:20OqokSSRDHDqJg4@twitter.hkmjkrg.mongodb.net/?retryWrites=true&w=majority";
